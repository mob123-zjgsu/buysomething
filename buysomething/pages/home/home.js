Page({
  ...
  handleFunctionClick(e) {
    ...
    switch(type) {
    case 'seckill':
      wx.navigateTo({ url: '/pages/product-list/product-list?sort=discount' });
      break;
    case 'discount':
      wx.navigateTo({ url: '/pages/product-list/product-list?sort=price' });
      break;
    case 'new':
      wx.navigateTo({ url: '/pages/product-list/product-list?sort=new' });
      break;
    case 'brand':
      wx.navigateTo({ url: '/pages/product-list/product-list?sort=brand' });
      break;
    case 'coupon':
